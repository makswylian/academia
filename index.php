...
if (isset($_POST['usuario'])) {
    ...
    $LoginRS = mysql_fetch_array($LoginRS);
                ...
                <table border="0" cellspacing="3" cellpadding="0">
                    <tr>
                        <td class="login_campo"><label>
                                <input name="usuario" type="text" id="usuario" onfocus="if (this.value == 'Usuario')
                                            this.value = ''" value="Usuario" maxlength="23" />
                            </label></td>
                    </tr>
                    <tr>
                        <td class="login_campo"><label>
                                <input name="senha" type="password" id="senha" onfocus="if (this.value == 'Senha')
                                            this.value = ''" value="Senha" maxlength="20" />
                            </label></td>
                    </tr>
                    <tr>
