...
$query_Recordset1 = sprintf("SELECT * FROM usuario WHERE usuario = %s", GetSQLValueString($colname_Recordset1, "text"));
$Recordset1 = mysql_query($query_Recordset1, $academiaconexao) or die(mysql_error());
...
<body>
<div class="conteudo">
  <div class="bemvindo"><?php echo $row_Recordset1['nome']; ?></div>
